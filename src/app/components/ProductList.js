        ...
        <li key={product.id} className="flex justify-between items-start p-4 bg-white border border-gray-300 rounded-lg shadow-md transition-transform transform hover:scale-105">
          ...
          <div className="flex-shrink-0 flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition ease-in-out duration-150"
            >
              Edit
            </button>
            <button
